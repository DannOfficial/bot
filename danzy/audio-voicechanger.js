...
let danz = async (m, { conn, args, usedPrefix, command }) => {
    try {
...
danz.help = ['bass', 'blown', 'deep', 'earrape', 'fast', 'fat', 'nightcore', 'reverse', 'robot', 'slow', 'smooth', 'tupai', 'vibra'].map(v => v + ' <vn>')
danz.tags = ['audio']
danz.command = /^(bass|blown|deep|earrape|fas?t|nightcore|reverse|robot|slow|smooth|tupai|squirrel|chipmunk|vibra)$/i
danz.limit = true
